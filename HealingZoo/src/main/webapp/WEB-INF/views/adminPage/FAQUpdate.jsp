...
<body>
	...
	<div class="container" style="width: 900px; margin-top: 100px; margin-bottom: 100px;">
		<form action="${ contextPath }/updateFAQ.admin">
			<div  style='margin-bottom: 100px;'>
				...
				<div class='row'>
					...
					<div class='col-7 text-center'>
						<input class="form-control" type="text" id="faqTitle" name='boardTitle' value='${faq.boardTitle }'>
					</div>
					<div class='col-2'></div>
				</div>
				...
				<div class='row' style='margin-bottom:30px;'>
					...
					<div class='col-7 text-center'>
						<textArea cols='48' rows='10' id='faqContent' name='boardContent'>${ faq.boardContent }</textArea>
					</div>
					<div class='col-2'></div>
				</div>
