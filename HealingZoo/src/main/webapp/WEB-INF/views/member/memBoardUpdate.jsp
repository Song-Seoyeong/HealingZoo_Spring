...
<body>
	...
	<!-- /헤더 -->
		...
		<!-- 글쓰기 폼 -->
		<form action='${ contextPath }/updateBoard.me' method='post' enctype='multipart/form-data'>
			    ...
			    <div class="col-8" style='background: white; border-radius: 25px;'>
			    	...
			    	<c:if test="${ b.cateNo == 100 }">
				    	<div class='row'>
						    ...
						    <div class='col-2'>
						    	<input  type='text' name='boardWriterName' placeholder='이름을 입력해주세요' id='inputBoardWriter' size='20'  class='inputBoard' value='${ name }'>
							</div>
							<div class='col-1'></div>
						</div>
					</c:if>
					<c:if test="${ b.cateNo != 100 }">
				    	<div class='row'>
						    ...
						    <div class='col-3'>
						    	<input  type='text' name='boardWriterName' placeholder='이름을 입력해주세요' id='inputBoardWriter' size='20'  class='inputBoard' value='${ b.boardWriterName }' readonly>
							</div>
							<div class='col-1'></div>
						</div>
					</c:if>
					...
					<c:if test="${ b.cateNo == 103 || b.cateNo == 101 }">
						<div class='row'>
							...
							<div class='col-5 text-start'>
								<input type='text' name='writerPhone' placeholder='핸드폰 번호를 입력해주세요' id='writerPhone' size='30' class='inputBoard' onchange='checkPhoneReg()' value='${ b.writerPhone }' required readonly>
							</div>
						...
						<div class='row'>
							<div class='col-1'></div>
							<div class='col-5 text-start'>
								<input type='password' id='boPwd' name='boPwd' class='inputBoard contain-fluid' size='30' value="${b.boPwd}" placeholder='글 비밀번호를 입력해주세요' onchange='checkPwdReg()' required/>
							</div>
